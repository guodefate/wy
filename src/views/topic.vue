...
<div class="topic" >
  <div class="wrap">
     ...
     <div class="content-wrap-box">
        ...
        <img class='topic-icon' v-else-if="title.dType===2" :src=" 'http://192.168.0.115:8081/hqcd/download'+ title.content" alt="">
       </div>
     </div>
    <div class="div"></div>
    <div class="footer" >
...
export default {
  ...
  methods:{
    ...
    //   }
      ...
      //console.log(contId)
       var ifrSrc='dzt://dzt.com?type=3&contentId='+contId
       //console.log(ifrSrc)
